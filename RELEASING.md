...
This SDK uses automated tag-based releases via GitHub Actions with npm Trusted Publishing (OIDC).
...
1. [GitHub Actions](https://github.com/vidaldiego/zn-vault-sdk-node/actions) - workflow status
2. [npm](https://www.npmjs.com/package/@zincapp/znvault-sdk) - published version
